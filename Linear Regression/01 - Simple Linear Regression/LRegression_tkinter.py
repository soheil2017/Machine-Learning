...
canvas1.create_window(120, 220, window=label_Intercept)

# with sklearn
Coefficients_result = ('Coefficients: ', regr.coef_)
label_Coefficients = tk.Label(root, text=Coefficients_result, justify='center')
canvas1.create_window(120, 240, window=label_Coefficients)
...
canvas1.create_window(640, 220, window=label_model)

# New_Interest_Rate label and input box
label1 = tk.Label(root, text='Type Interest Rate: ')
canvas1.create_window(0, 100, window=label1)

entry1 = tk.Entry(root)  # create 1st entry box
canvas1.create_window(140, 100, window=entry1)

# New_Unemployment_Rate label and input box
label2 = tk.Label(root, text=' Type Unemployment Rate: ')
canvas1.create_window(0, 120, window=label2)

entry2 = tk.Entry(root)  # create 2nd entry box
canvas1.create_window(140, 120, window=entry2)
